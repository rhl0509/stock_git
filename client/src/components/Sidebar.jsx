  ...
  return (
    <>
      <aside className={`sidebar${open ? ' active' : ''}`} id="sidebar">
        <NavLink to="/stock_dashboard" className="sidebar-logo" onClick={onClose}>
        ...
        <div className="nav-section">
          ...
          {user && (<>
            ...
            <ul className="list-unstyled mb-0">
              ...
              {recPassActive && link('/recommend', 'bi-stars', 'AI 추천')}
              {link('/stock_recommend_history','bi-clock-history',   '추천 기록')}
